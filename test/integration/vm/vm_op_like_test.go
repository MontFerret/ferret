...
func TestLikeOperator(t *testing.T) {
	RunSpecs(t, []spec.Spec{
		...
		Array(`RETURN FOR str IN ["foo", "bar", "qaz"] FILTER str LIKE "*a*" RETURN str`, []any{"bar", "qaz"}),
		Array(`RETURN FOR str IN ["foo", "bar", "qaz"] FILTER str NOT LIKE "*a*" RETURN str`, []any{"foo"}),
		Array(`RETURN FOR str IN ["ar", "bar", "qaz"] FILTER str LIKE "a*" RETURN str`, []any{"ar"}),
		Array(`RETURN FOR str IN ["ar", "bar", "qaz", "fa", "da"] FILTER str LIKE "*a" RETURN str`, []any{"fa", "da"}),
	})
}
