...
func TestStdlibArityOverloads(t *testing.T) {
	RunSpecs(t, []spec.Spec{
		...
		S(`RETURN REPLACE("aba", "a", "x")`, "xbx", "three-argument overload"),
		S(`RETURN REPLACE("aaa", "a", "x", 2)`, "xxa", "four-argument overload"),
		...
		Array(`RETURN REGEX_SPLIT("a,b,c", ",", 2)`, []any{"a", "b,c"}, "regex split preserves the unsplit remainder"),
