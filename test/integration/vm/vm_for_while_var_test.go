...
func TestForWhileWithVarState(t *testing.T) {
	RunSpecs(t, []spec.Spec{
		Array(`
			VAR i = 0
			RETURN FOR WHILE i < 5
				i = i + 1
				RETURN i - 1
		`, []any{0, 1, 2, 3, 4}),
		Array(`
			VAR i = 0
			RETURN FOR WHILE i < 10
				i = i + 2
				RETURN i - 2
		`, []any{0, 2, 4, 6, 8}),
		Array(`
			VAR i = 10
			RETURN FOR WHILE i > 0
				i = i - 3
				RETURN i + 3
		`, []any{10, 7, 4, 1}),
		Array(`
