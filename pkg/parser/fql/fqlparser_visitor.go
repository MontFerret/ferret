...
type FqlParserVisitor interface {
	...
	// Visit a parse tree produced by FqlParser#deleteStatement.
	...
	// Visit a parse tree produced by FqlParser#assignmentTargetPath.
	VisitAssignmentTargetPath(ctx *AssignmentTargetPathContext) interface{}
