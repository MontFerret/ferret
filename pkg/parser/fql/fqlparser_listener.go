...
type FqlParserListener interface {
	...
	// EnterUseExpressionShortcut is called when entering the useExpressionShortcut production.
	EnterUseExpressionShortcut(c *UseExpressionShortcutContext)
	...
	// ExitUseExpressionShortcut is called when exiting the useExpressionShortcut production.
	ExitUseExpressionShortcut(c *UseExpressionShortcutContext)
