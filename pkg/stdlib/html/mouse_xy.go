...
// MoveMouseXY moves mouse by given coordinates.
// @param doc (HTMLDocument) - Target document or element.
// @param selector (String, options) - If document is passed, this param must represent an element selector.
func MoveMouseXY(_ context.Context, args ...core.Value) (core.Value, error) {
	...
	if len(args) == 2 {
		...
		return values.None, doc.MoveMouseBySelector(selector)
	}
