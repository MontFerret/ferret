...
func SetInnerHTML(ctx context.Context, args ...core.Value) (core.Value, error) {
	...
	if len(args) == 2 {
		...
		return core.None, el.SetInnerHTML(ctx, internal.ToString(args[1]))
	}
	...
	innerHTML := internal.ToString(args[2])

	return core.None, el.SetInnerHTMLBySelector(ctx, selector, innerHTML)
}
