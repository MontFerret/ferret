...
var assertionCatalog = []assertionRegistration{
	{name: "approx", descriptor: approxAssertion, negatable: true},
	{name: "between", descriptor: betweenAssertion, negatable: true},
	{name: "bool", descriptor: boolAssertion, negatable: true},
	{name: "contains", descriptor: containsAssertion, negatable: true},
	{name: "duration", descriptor: durationAssertion, negatable: true},
	...
	{name: "has", descriptor: hasAssertion, negatable: true},
	...
	{name: "number", descriptor: numberAssertion, negatable: true},
