...
func range3(ctx context.Context, arg1, arg2, arg3 runtime.Value) (runtime.Value, error) {
	...
	step := rangeNumber(arg3)
	start := rangeNumber(arg1)
	end := rangeNumber(arg2)
...
// Range arguments have already been validated as native numbers.
func rangeNumber(value runtime.Value) float64 {
	if integer, ok := value.(runtime.Int); ok {
		return float64(integer)
	}

	return float64(value.(runtime.Float))
}
