...
func TestNamespaceBuilder(t *testing.T) {
	Convey("Namespaces", t, func() {
		Convey("Should return an error when a function name contains NS separator", func() {
			c := compiler.New()
			err := c.RegisterFunction("FOO::SPY", func(ctx context.Context, args ...Value) (value Value, e error) {
				return None, nil
			})
		...
		Convey("Should successfully register a name within a namespace", func() {
			c := compiler.New()
			err := c.Namespace("FOO").RegisterFunction("SPY", func(ctx context.Context, args ...Value) (value Value, e error) {
				return None, nil
			})
		...
		Convey("Namespace should return all registered functions", func() {
			...
			err = c.Namespace("FOO").Namespace("UTILS").RegisterFunction("SPY", func(ctx context.Context, args ...Value) (value Value, e error) {
				return None, nil
			})
		...
		Convey("Namespace should return an error if namespace name is incorrect", func() {
			c := compiler.New()
			noop := func(ctx context.Context, args ...Value) (value Value, e error) {
				return None, nil
			}
