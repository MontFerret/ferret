...
func (iter *RangeIterator) HasNext(ctx runtime.Context) (bool, error) {
	if !iter.descending {
...
func (iter *RangeIterator) Next(ctx runtime.Context) (value runtime.Value, key runtime.Value, err error) {
	iter.counter++
