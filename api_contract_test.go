...
func publicExports() []publicExport {
	return []publicExport{
		...
		{name: "WithSessionRandomSeed", kind: token.FUNC, target: "pkg/engine.WithSessionRandomSeed", root: ferret.WithSessionRandomSeed, owner: engine.WithSessionRandomSeed},
